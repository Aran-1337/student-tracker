...
export default function BillsManagement() {
  ...
  // Filter state
  const [activeFilter, setActiveFilter] = useState<string>("all"); // 'all' or month string representation (1-12)
                ...
                <tbody>
                  {filteredBills.map(bill => {
                    ...
                    const catColors: Record<string, string> = {
                      "إيجار": "rgba(59, 130, 246, 0.15); color: #60a5fa; border: 1px solid rgba(59, 130, 246, 0.2)",
                      "رواتب سكرتارية": "rgba(167, 139, 250, 0.15); color: #c084fc; border: 1px solid rgba(167, 139, 250, 0.2)",
                      "أخرى": "rgba(156, 163, 175, 0.15); color: #9ca3af; border: 1px solid rgba(156, 163, 175, 0.2)"
                    };
